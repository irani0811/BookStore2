...
#     return 520, error_code[520].format(order_id)  # 新增的方法
...
error_code = {
    ...
    518: "invalid order id {}",
    519: "not sufficient funds, order id {}",
    520: "order not cancelable, order id {}",
    521: "error_not_delivery, order id {}",
    522: "error_not_cancel_order, order id {}",
    523: "error_missing_order, order id {}",
    524: "error_invalid_store_id",
    525: "error_invalid_order_status",
    526: "",
    527: "",
    528: "",
...
def error_order_not_cancelable(order_id):
    return 520, error_code[520].format(order_id)


def error_not_delivery(order_id):
    return 521, error_code[521].format(order_id)


def error_not_cancel_order(order_id):
    return 522, error_code[522].format(order_id)


def error_missing_order(order_id):
...
def error_non_exist_order(user_id):
    return 529, error_code[529].format(user_id), {}
